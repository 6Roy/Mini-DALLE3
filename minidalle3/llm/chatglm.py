...
if __name__ == "__main__":
    tokenizer = AutoTokenizer.from_pretrained("/sshfs/pretrains/THUDM/chatglm3-6b", trust_remote_code=True)
    model = AutoModel.from_pretrained("/sshfs/pretrains/THUDM/chatglm3-6b", trust_remote_code=True).cuda()
